package com.example.daffolapmac.wealthbook.screen.pendingalert.view;
 ...
 */
public class PendingAlertFragment extends Fragment {
     ...
     */
    public static PendingAlertFragment newInstance() {
